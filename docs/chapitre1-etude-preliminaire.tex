...
\begin{figure}[hbt!]
    \centering
    % TODO : décommenter et renommer l'image
    %\fbox{\includegraphics[width=0.8\textwidth]{images/linkedin.png}}
...
\begin{figure}[hbt!]
    \centering
    % TODO : décommenter et renommer l'image
    %\fbox{\includegraphics[width=0.8\textwidth]{images/workday.png}}
...
\begin{figure}[hbt!]
    \centering
    % TODO : décommenter et renommer l'image
    %\fbox{\includegraphics[width=0.8\textwidth]{images/greenhouse.png}}
...
\begin{itemize}
    ...
    \item \textbf{Scrum Master :} Madame Maissa ZAMMOURI --- garante du respect du cadre Scrum et facilitatrice lors des cérémonies (daily, sprint review, rétrospective).
