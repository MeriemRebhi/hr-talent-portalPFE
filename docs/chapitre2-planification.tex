...
\begin{figure}[p]
  \centering
  % \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{images/usecasev4.png}
...
\begin{figure}[hbt!]
  \centering
  % \includegraphics[width=12cm]{images/Architecture_Physique.png}
...
\begin{figure}[hbt!]
  \centering
  % \includegraphics[width=12cm]{images/Architecture_Logique2.png}
