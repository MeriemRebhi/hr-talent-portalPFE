...
export default class JobList extends NavigationMixin(LightningElement) {
    ...
    handleFilter(event) {
        const { keyword, localisation, contrat, departement } = event.detail;
        ...
        this.jobs = this.allJobs.filter(job => {
            ...
            const matchDepartement = !departement ||
                (job.Departement__c && job.Departement__c === departement);

            return matchKeyword && matchLocalisation && matchContrat && matchDepartement;
        });
    }
